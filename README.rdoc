...
Then, simply put this in your Person model:
...
And, of course, because you're using FlexDate, you can store partial dates,
so you don't need to know the year to store the month and day of someone's
birthday.
...
field type which is the perfect compliment to MultipartDate in your Rails
